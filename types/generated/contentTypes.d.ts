...
export interface ApiCompraCompra extends Schema.CollectionType {
  ...
  attributes: {
    ...
    productosComprados: Attribute.Relation<
      'api::compra.compra',
      'oneToMany',
      'api::funko.funko'
    >;
    estado_compra: Attribute.Relation<
      'api::compra.compra',
      'oneToOne',
      'api::estado-compra.estado-compra'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiEstadoCompraEstadoCompra extends Schema.CollectionType {
  collectionName: 'estado_compras';
  info: {
    singularName: 'estado-compra';
    pluralName: 'estado-compras';
    displayName: 'estadoCompra';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    Estado: Attribute.Enumeration<
      ['En Preparaci\u00F3n', 'Entregada', 'Cancelada']
    >;
    name: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::estado-compra.estado-compra': ApiEstadoCompraEstadoCompra;
